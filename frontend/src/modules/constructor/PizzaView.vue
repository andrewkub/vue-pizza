...
const pizzaClass = computed(() => {
  const size = props.pizza.dough === "large" ? "big" : "small";
  const sauce = props.pizza.sauce;
  ...
  <div class="content__constructor">
    <div class="pizza" :class="pizzaClass">
      <div class="pizza__wrapper">
        <div
          v-for="(count, ingredientName) in props.pizza.ingredients"
          :key="ingredientName"
          :class="{
            pizza__filling: true,
            [`pizza__filling--${ingredientName}`]: true,
